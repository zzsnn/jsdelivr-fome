...
/*添加图片top*/
var top_up = "<img id='upj' class='upj' style='max-width:300%;cursor:pointer;position:fixed;right:-40px;top:-750px;z-index:2;width:70px;height:900px;' src='https://www.xcnte.com/usr/plugins/GoTop/images/scroll.png' title='回到顶部' >";
/*添加到返回顶部按钮下*/
