...
"<div id=\"myhkLrc\"></div>");
		if (top.location != self.location) {
			...
			$songFrom.html("<a style=\"color:#f00\">梨花带雨</a>");
				...
				creat: {
					album: function() {
						if (typeof myhkid === "undefined") {
							...
							$(".musicheader", $albumList).html("<a href=\"" + webURL + "\" title=\"欢迎使用梨花带雨播放器</a>")
						};
			...
			$.ajax({
				...
				success: function() {
					if (typeof myhkid !== "undefined") {
						$(".myhkgeci", $player).html("<a style=\"float: right\" href=\"" + webURL + "\" title=\"点击免费申请梨花带雨播放器\" target=\"_blank\"><i class=\"fa fa-share-alt\"></i> 免费申请</a>");
